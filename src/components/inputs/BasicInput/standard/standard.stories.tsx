...
import StandardInputTemplate, { defaultProps, StandardInputProps } from './StandardInput'
...
const StandardInput: FC<StandardInputProps> = props => {
   ...
   return <StandardInputTemplate value={value} onChange={handleSetValue} {...props} />
}

const preparedProps = { ...defaultPrototypeProps, ...defaultProps }

const meta: Meta<typeof StandardInput> = {
   title: 'Inputs/Basic/StandardInput',
